...
export const nav_links = writable([
    ...
    {url: "/petri-net-type-systems-correspondence", title: "Finding correspondences between Petri net constructs and type system features", date_written: "15 February 2025", est_read_time: 0}
])
